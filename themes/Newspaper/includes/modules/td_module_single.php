        ...
        $buffy .= '<div class="td-post-sharing td-post-sharing-top ' . $td_no_like . '">';
	        ...
	        if (td_util::get_option('tds_top_social_show') != 'hide') {
				...
				<div class="td-default-sharing">
		            <a class="td-social-sharing-buttons td-social-facebook" href="http://www.facebook.com/sharer.php?u=' . urlencode( esc_url( get_permalink() ) ) . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><i class="td-icon-facebook"></i><div id="facebook" class="td-social-but-text"><span>' . __td('Share on Facebook', TD_THEME_NAME) . '</span><span class="resp">' . __td('Facebook', TD_THEME_NAME) . '</span></div></a>
		            <a class="td-social-sharing-buttons td-social-twitter" href="https://twitter.com/intent/tweet?text=' . htmlspecialchars(urlencode(html_entity_decode($this->title, ENT_COMPAT, 'UTF-8')), ENT_COMPAT, 'UTF-8') . '&url=' . urlencode( esc_url( get_permalink() ) ) . '&via=' . urlencode( $twitter_user ? $twitter_user : get_bloginfo( 'name' ) ) . '"  ><i class="td-icon-twitter"></i><div id="twitter" class="td-social-but-text"><span>' . __td('Tweet on Twitter', TD_THEME_NAME) . '</span><span class="resp">' . __td('Twitter', TD_THEME_NAME) . '</span></div></a>
		            <a class="td-social-sharing-buttons td-social-whatsapp" href="whatsapp://send?text=' . htmlspecialchars(urlencode(html_entity_decode($this->title, ENT_COMPAT, 'UTF-8')), ENT_COMPAT, 'UTF-8') . ' - ' . urlencode( esc_url( get_permalink() ) ) . '" data-action="share/whatsapp/share"><i class="td-icon-whatsapp"></i></a>
	            </div>';
	        }
