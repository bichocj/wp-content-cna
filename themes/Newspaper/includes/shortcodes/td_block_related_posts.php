...
class td_block_related_posts extends td_block {
    ...
    function render($atts, $content = null) {
        ...
        $buffy .= '<h4 class="td-related-title">';
            $buffy .= '<span id="' . td_global::td_generate_unique_id() . '" class="td-related-left td-cur-simple-item" data-td_filter_value="" data-td_block_id="' . $this->block_uid . '">' . 'Recomendamos' . '</span>';
