        ...
        <ul class="lnList">
            ...
            <li>
                <?php 
                        ...
                        echo '<div class="nWrapper"><a class="nImage" href="'. $urlNews .'"> <img width="150" height="150" class="entry-thumb td-animation-stack-type0-1 hidden-xs" src="'.$imgDestacada[0].'"
                        alt="" title="'.$imgTitle.'"> </a></div>'
                ?>
                <div class="nTitle">
