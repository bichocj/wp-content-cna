        ...
        <div class="td-header-sp-logo">
            <h1 class="td-logo"> 
                <a class="td-main-logo" href="/">
                    <img class="td-retina-data" src="<?php echo get_template_directory_uri(); ?>/images/custom/cna-envivonuevo-white.png" alt="CNA televisión, en todo el mundo" title="CNA, en todo el mundo">
